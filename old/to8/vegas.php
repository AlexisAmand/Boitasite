...
<head>
  ...
  <title>Le jeu Las Vegas pour micro-ordinateurs Thomson | A la découverte du Thomson TO8</title>
  <meta name="description" content="A propos du jeu Las Vegas sortis sur les micro-ordinateurs Thomson TO8 dans les années 80">
    ...
    <section id="content">
    	<div class="container_12">
            ...
            <div class="grid_12 box-2">
            	...
            	<div>
                    <h1 class="text-3">Le jeu <span>Las Vegas</span> pour TO8</h1>               
                </div>
            </div>
            ...
            <p><br /><br />Un jeu édité par Infogrames.</p>

            <p style="text-align:center;margin-top:25px;">
            <img src="images/tilt-34-02.jpg" width="450px" alt="publicité pour le jeu Las Vegas parue dans Tilt n°34 de septembre 1986">
            <br /><br />
