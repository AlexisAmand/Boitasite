          ...
          <div>                 	
              ...
              <nav>  
                <ul class="menu">
                      ...
                      <li class="current"><a href="to8.php">TO8</a></li>
    ...
    <section id="content"></div>
    	<div class="container_12">
            ...
            <div style="clear:both">
                ...
                <a href="to8/images/thomson_t08_04.jpg" id="single_image">
                ...
                <p>Si vous avez envie de (re)découvrir le TO8, je vous conseille l'utilisation de <a href="http://dcmoto.free.fr/">DCMOTO</a>. C'est un logiciel qui émule sous Windows les machines telles que le Thomson MO5, le MO5E, le MO5NR, le MO6, le T9000, le TO7, le TO7/70, le TO8, le TO8D, le TO9, le TO9+ ou encore l'Olivetti Prodest PC128. Le site propose aussi un accès à plus de 850 jeux et programmes divers ainsi que plus de 160 livres et documents. De mon côté, j'utilise plutôt l'émulateur MESS (Multi Emulator Super System), il est juste un peu plus délicat à configurer.</p>
                <br />
