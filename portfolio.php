...
@media screen and (max-width: 767px) {
  .timeline::before {
    left: 10px; /* recentre un peu la ligne */
  }
...
.timeline-item.left::after {
  ...
  right: 0px; /* décale vers la droite */
  width: 32px; /* longueur du trait */
  height: 4px; /* épaisseur */
  background-color: #dee2e6;;
  transform: translateY(-50%); /* centre le trait */
}
...
.timeline-item.right::after {
  ...
  position: absolute;
  top: 50%; /* milieu vertical */
  left: 0px; /* décale vers la gauche */
  width: 32px;
  height: 4px;
  background-color: #2674b60f;
...
@media (max-width: 768px) {
  ...
  position: absolute;
  top: 50%; /* milieu vertical */
  left: 6px; /* décale vers la gauche */
  width: 25px;
  height: 4px;
  background-color: #2674b60f;
  transform: translateY(-50%);
...
<body>
  ...
  <?php include $_SERVER['DOCUMENT_ROOT'].'/inc/nav.inc.php'; ?>
    ...
    <section id="portfolio-timeline" class="py-5 bg-light text-center">
      <div class="container">
        <h2 class="display-5 my-5">Mon portfolio</h2>
        
          <div class="row">
            <div class="col-12 text-center mb-2">
              <p class="lead">  Voici quelques exemples de sites web que j’ai réalisés pour des entreprises, associations et indépendants. Chaque projet est conçu sur mesure, avec une attention particulière portée à la performance, au référencement naturel (SEO) et à l’expérience utilisateur.</p>
            </div> 
          <div> 
        <div class="timeline">
          ...
          <div class="timeline-item left">
            <div class="content">
              <h4>2018– Le Gasp</h4>
              <p>Jeu en ligne réalisé en JavaScript.</p>
              <img src="img/capture-03.webp" class="card-img-top" alt="Jeu en ligne développé par Alexis AMAND, aperçu de l’interface" loading="lazy" width="640" height="360">          
                <a href="http://thegasp.genealexis.fr/" target="_blank" class="btn btn-sm btn-primary mt-2" role="button">
                  Voir le site
                </a> 
            </div>
          </div>
          ...
          <div class="timeline-item right">
            <div class="content">
              <h4>2017 – PubliGED</h4>
              <p>Projet de création d'un CMS dédié à la généalogie.</p>
              <img src="img/capture-01.webp" class="card-img-top" alt="Page d’accueil du site officiel du projet PubliGED" loading="lazy" width="640" height="360">
                <a href="https://www.publiged.com/" target="_blank" class="btn btn-sm btn-primary mt-2" role="button">
                  Voir le site
                </a>  
            </div>
          </div>
