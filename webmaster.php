   ...
   <header> 
    ...
    <section id="content">
    	<div class="container_12">
        	...
        	<div style="text-align:center;margin-top:45px;margin-bottom:45px;font-size:1.2em;font-size: 1.8em;">
            Avoir un site 100 % opérationnel, 100 % efficace, 24h sur 24 et 7 jrs sur 7 !
			</div>
			
			<div style="width:50%;float:left;"> 
	  			<ul style="width:320px;margin-left:auto;margin-right:auto;">
            ...
            <h2 style="margin-top:40px;margin-bottom:10px;text-align:center;">Quelques réalisations...</h2>
			
			<br />

				<div style="text-align:center;">
	                <img src="images/captures/thegasp.jpg" alt="Capture d'écran d'un site réalisé par Alexis AMAND" style="border:7px solid white;margin:10px 10px 10px 10px;">
	                <img src="images/captures/transmediation.jpg" alt="Capture d'écran d'un site réalisé par Alexis AMAND" style="border:7px solid white;margin:10px 10px 10px 10px;">
	                <img src="images/captures/hdp.jpg" alt=" " style="border:7px solid white;margin:10px 10px 10px 10px;">
	                <img src="https://via.placeholder.com/164x129?text=prochainement" alt=" " style="border:7px solid white;margin:10px 10px 10px 10px;">
				</div>
