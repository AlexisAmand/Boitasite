    ...
    <section class="container">
        ...
        <article class="row d-flex justify-content-center ligne-dotted-top">
            ...
            <div class="col-12 py-5 mb-3 ligne-dotted-bottom">
                <h1 class="text-center">#seo : Premiers <span>pas en référ</span>encement</h1>
            </div>
            ...
            <p>N'oubliez pas que cette balise doit être placée en haut de la page, entre le &lt;head&gt; et &lt;/head&gt;.</p>

            <h5 class="mt-5">2) La "meta description"</h5>
            ...
            <p>Comme pour &lt;title&gt;, la balise meta description doit être placé entre le &lt;head&gt; et &lt;/head&gt;, en haut de la page.</p>

            <h5 class="mt-5">3) Les titres HX</h5>
            ...
            <h5 class="mt-5">Pour aller plus loin</h5>
