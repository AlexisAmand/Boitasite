...
<html lang="fr">
<head>
    <title>Choplifter pour micro-ordinateurs Thomson</title>
    <meta charset="utf-8">

    <meta name="description" content="Description du jeu Choplifter, édité par XXXX, qui était disponible sur les ordinateurs Thomson dans les années 80">
    ...
    <section id="content"></div>
    	<div class="container_12">
            ...
            <div class="grid_12 box-2">
            	...
            	<div>
                    <h1 class="text-3">Le jeu <span>Choplifter</span> pour TO8</h1>                    
                </div>
            </div>
            ...
            <img src="images/choplifter/choplifter-01.jpg" width="300px"  alt="capture d'écran du jeu Choplifter pour thomson TO8" style="margin-bottom:14px;margin-left:7px;margin-right:7px;"/>          
            <img src="images/choplifter/choplifter-02.jpg" width="300px"  alt="capture d'écran du jeu Choplifter pour thomson TO8" style="margin-bottom:14px;margin-left:7px;margin-right:7px;"/>
