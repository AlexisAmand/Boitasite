...
<html lang="fr">
<head>
    <title>Aide à la lecture version 1 pour micro-ordinateurs Thomson</title>
    <meta charset="utf-8">

    <meta name="description" content="A propos du logiciel d'Aide à la lecture version 1 sorti sur les micro-ordinateurs Thomson TO8 dans les années 80">
    ...
    <section id="content">
    	<div class="container_12">
            ...
            <div class="grid_12 box-2">
            	...
            	<div>
                    <h1 class="text-3">Aide à la lecture v1 <span>pour</span> TO8</h1>
            ...
            <p>Alerte: Entraînement à la lecture sélective pour stimuler l'attention, accélérer la vitesse de lecture.<br />
            Mémot: reconstitution d'un texte court pour l'appropriation des structures de texte et aussi de l'orthographe.
