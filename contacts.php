...
<html lang="fr">
  <head>
    ...
    <title>Alexis AMAND - développement web et SEO à Valenciennes</title>
    <meta name="description" content="Notre équipe est à votre disposition pour répondre à vos questions sur le domaine de l'informatique, de la création et du référencement de site web à Valenciennes. N'hésitez pas à nous contacter !">
    ...
    <section class="container">
        ...
        <article class="row d-flex justify-content-center ligne-dotted-top">
            ...
            <div class="col-12 py-5 mb-3 ligne-dotted-bottom">
                <h1 class="text-center">#contact : Pour me <span>contact</span>er</h1>
            </div>
            ...
            <p class="text-center mt-4">
                <a href="https://twitter.com/boitasite" title="lien pour me suivre sur Twitter">
                <i class="fi-swluxl-twitter" style="font-size:2em"></i></a>
                <a href="https://www.facebook.com/Alexis-AMAND-Webmaster-507308975998494/" title="lien pour me suivre sur Facebook">
                <i class="fi-swluxl-facebook" style="font-size:2em"></i></a>
                <a href="https://www.linkedin.com/in/alexis-amand-99775817" title="lien pour me suivre sur LinkedIn">
